  ...
  -- LSP and linting setup combined
  {
    ...
    dependencies = {
      ...
      { 'WhoIsSethDaniel/mason-tool-installer.nvim', opts = {
        ensure_installed = {
          -- LSPs
          'lua-language-server', 'clangd', 'jdtls', 'pyright', 'ts_ls', 'html', 'cssls', 'tailwindcss', 'jsonls', 'yamlls', 'marksman', 'kotlin-language-server', 'emmet-ls', 'dockerls', 'bashls',
          -- Linters
          'luacheck', 'markdownlint', 'jsonlint', 'ts-standard',
        },
        auto_update = true,
        run_on_start = true,
      }},
